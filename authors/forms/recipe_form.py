...
class AuthorRecipeForm(forms.ModelForm):
    ...
    def clean_description(self):
        ...
        if len(description) < 10:
            self._my_errors['description'].append('Description must have at least 10 characters.')  # noqa: E501
    ...
    def clean_preparation_time(self):
        ...
        if not is_positive_number(field_value):
            self._my_errors[field_name].append('Must be a positive number')  # noqa: E501
